...
const S: Record<string, CSSProperties> = {
  page:    { minHeight:"100vh", background:"radial-gradient(ellipse 800px 500px at 85% 20%, rgba(224,57,158,.038) 0%, transparent 60%), #fbf7f4", fontFamily:font, padding:"0 20px 60px" },
